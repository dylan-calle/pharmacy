...
router.get("/getRawMaterialExpectId", registerRawController.getRawMaterialExpectId);
...
router.post("/existsNotSameRawMaterial", registerRawController.existsNotSameRawMaterial);
router.post("/verifyIfReferencesofRawExists", registerRawController.verifyIfReferencesofRawExists);
